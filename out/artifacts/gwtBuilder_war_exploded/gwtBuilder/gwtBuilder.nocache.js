function gwtBuilder(){
  ...
  gwtBuilder.__sendStats = sendStats;
  gwtBuilder.__moduleName = $intern_4;
  gwtBuilder.__errFn = null;
  gwtBuilder.__moduleBase = $intern_6;
  gwtBuilder.__softPermutationId = $intern_7;
  gwtBuilder.__computePropValue = null;
  gwtBuilder.__getPropMap = null;
  gwtBuilder.__installRunAsyncCode = function(){
  }
  ;
  gwtBuilder.__gwtStartLoadingFragment = function(){
    return null;
  }
  ;
  gwtBuilder.__gwt_isKnownPropertyValue = function(){
    return false;
  }
  ;
  gwtBuilder.__gwt_getMetaProperty = function(){
    return null;
  }
  ;
  ...
  gwtBuilder.__moduleStartupDone = function(permProps){
    var oldBindings = activeModules[$intern_4].bindings;
    activeModules[$intern_4].bindings = function(){
      var props = oldBindings?oldBindings():{};
      var embeddedProps = permProps[gwtBuilder.__softPermutationId];
  ...
  function installScript(filename){
    ...
    function installCode(code_0){
      ...
      script.src = code_0;
      if (gwtBuilder.__errFn) {
        script.onerror = function(){
          gwtBuilder.__errFn($intern_4, new Error($intern_22 + code_0));
        }
        ;
      }
  ...
  gwtBuilder.__startLoadingFragment = function(fragmentFile){
    return computeUrlForResource(fragmentFile);
  }
  ;
  gwtBuilder.__installRunAsyncCode = function(code_0){
    var doc = getInstallLocationDoc();
    var docbody = doc.body;
    var script = doc.createElement($intern_20);
    script.language = $intern_21;
  ...
  function processMetas(){
    ...
    gwtBuilder.__errFn = onLoadErrorFunc;
  }
  ...
  function computeUrlForResource(resource){
    ...
    return gwtBuilder.__moduleBase + resource;
  }
  ...
  function getCompiledCodeFilename(){
    ...
    ;
    gwtBuilder.__getPropMap = function(){
      var result = {};
    ...
    ;
    gwtBuilder.__computePropValue = computePropValue;
    $wnd.__gwt_activeModules[$intern_4].bindings = gwtBuilder.__getPropMap;
    ...
    gwtBuilder.__softPermutationId = softPermutationId;
  ...
  processMetas();
  gwtBuilder.__moduleBase = computeScriptBase();
  activeModules[$intern_4].moduleBase = gwtBuilder.__moduleBase;
...
gwtBuilder.succeeded = gwtBuilder();
